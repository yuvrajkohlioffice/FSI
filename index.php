...
<!--marquee behavior="alternate" direction="left" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();" style="color:#ff0000;font-size:16px;margin-top:-6px;">Due to some technical snag at NRSC, the dissemination of SNPP-VIIRS base Forest Fire alerts have been suspended till the problem is resolved.</marquee-->			
							...
							<tbody>
							    <tr>
									<td style="padding: 4px;">
									   <a href="#"><p>Welcome to Forest Survey of India</p></a>
									</td>
								</tr>
								<?php
				...
				?>
                        ...
                        <p>
<!-----------------------modified content--->
<table><tr><td><img src="/images/santosh-tiwari.jpg" style="width: 200px;
height: 111px;"></td><td style="padding-left: 5px;"><b>Shri Santosh Tewari, IFS </b><br>Director General<br> Forest Survey of India <br>Ministry of Environment Forest and Climate Change Govt. of India</td></br></table>
<!------------------------------------------>

<?php //echo $row_welcome['front'];?></p>
