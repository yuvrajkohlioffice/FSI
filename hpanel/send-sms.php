					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="sms1.php" enctype="multipart/form-data" id="form_page" name="form_page" class="form-horizontal" method="post">
								<input type="hidden" name="action" value="send">
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="help-block">e.g: date for which SMS to be send </span>
										</div>
									</div>

									<div class="form-actions">
										<button type="submit" class="btn purple">Send SMS</button>
