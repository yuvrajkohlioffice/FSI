			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Online Product Enquiries <small>Bulk Enquiry</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<div class="portlet-body flip-scroll">
								<table class="table-bordered table-striped table-condensed flip-content">
									...
									<tbody>
										<?php
										$count = 0;
										$res_enq = mysql_query("select * from enquiry");
										...
										<tr>
											...
											<td>
											<?php 											
											echo $row_details['product_name'];
											?></td>
											<td><?php 
											echo $row_details['name'];
											echo "<br><b>Organisation: </b>".$row_details['organization'];
											echo "<br><b>Contact No.: </b>".$row_details['mobile_no'];
											?></td>
											<td><?php echo $row_details['email'];?></td>
											<td><?php echo $row_details['enquiry'];?></td>
											<td><?php echo date("d-M-Y",strtotime($row_details['crdate']));?></td>
											<td align="center"><a href="product-enquiry.php?action=details&id=<?php echo $row_details['sno'];?>"><img src="images/detail1.gif" alt="Details"></a></td>
										</tr>
										<?php
										}
										?>
...
function view_details()
{
	...
	$query=mysql_query("select * from enquiry where sno='$contentid'");
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="product-enquiry.php">Form Details</a>
								<i class="icon-angle-right"></i>
							</li>
							<li><a href="product-enquiry.php">Product Enquiry</a></li>
						</ul>
						<!-- END PAGE TITLE & BREADCRUMB-->
					</div>
				</div>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption"><i class="icon-cogs"></i>Product Enquiry Details</div>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="#portlet-config" data-toggle="modal" class="config"></a>
									<a href="javascript:;" class="reload"></a>
