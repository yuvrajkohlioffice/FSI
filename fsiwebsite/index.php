...
if (!empty($common->meta_key))
	$meta_keywords = strip_tags($common->meta_key);
if (!empty($common->meta_desc))
	$meta_desc = strip_tags($common->meta_desc);
...
<head>
	...
	?>
	<meta name="author" content="Adxventure LLP., Dehradun">
	<?php
...
<body>
	...
	<section class="rev_slider_wrapper gardener-banner" style="height:400px;">
		<div id="slider1" class="rev_slider" data-version="5.0" style="height:400px;">
			<ul>
				<?php
				$count = 0;
				// Use mysqli or PDO in production
				$slider = mysql_query("SELECT * FROM sliders WHERE type = '_home' AND status = 'active' ORDER BY sorder, name");
				...
				?>
						<li data-transition="parallaxvertical">
							<a href="<?php echo $row_sliders['otherurl']; ?>" class="banner-btn" target="_blank">
								<img src="uploads/images/slides/<?php echo $row_sliders['banner']; ?>" alt="sliders" width="1920" height="575"
	...
	<section class="mq-sec">
		<div class="container-fluid">
			...
			?>
			<marquee behavior="scroll" direction="left" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();" style="line-height: 12px;margin-top: 30px;">
				<?php
		...
		<div class="container">
			<div class="row">
									...
									<tbody>
										<tr>
											<td style="padding: 4px;">
												<a href="#">
													<p>Welcome to Forest Survey of India</p>
												</a>
											</td>
										</tr>
										<?php
				...
				<div class="col-lg-5 col-md-8 col-sm-12 col-xs-12">
					...
					<?php if ($row_welcome['otherurl'] != "") { ?><div><a class="contact-button" href="<?php echo $row_welcome['otherurl']; ?>" target="<?php echo $row_welcome['target']; ?>">
								<div class="contact-us-button">Learn More</div><i class="fa fa-arrow-circle-right"></i>
							</a></div><?php } ?>
				</div>
				<div class="col-lg-4 col-md-9 col-sm-12 col-xs-12 ">
					...
					<div class="mg">
						<h3>
							<?php
							$row_welcome = mysql_fetch_array(mysql_query("select sno, front, heading, detail, otherurl, target, banner from welcome_sec where websitetype='english'"));
							echo $row_welcome['heading'];
							$bannerExists = 0;
							if ($row_welcome['banner'] != "" && file_exists("uploads/images/banner/" . $row_welcome['banner'])) {
								$bannerExists = 1;
	...
	<section id="our-services-gardener">
		<div class="container">
			...
			<div class="row">
				<?php
				$sno = 0;
				$query = "select title, package_heading, description, link, extension, image, target from services where status='active' and websiteType = 'English' and primeArea = 1 order by sorder, postdate asc";
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<div class="single-service-item">
							...
							<div class="service-text">
								<a href="<?php echo $link; ?>" target="<?php echo $target; ?>">
									<h4><?php echo $dataServices['title']; ?></h4>
								</a>
	...
	<section id="latest-project-gardener">
		<div class="container">
			<div class="section-title2">
				<p><?php $eventGallery = mysql_fetch_array(mysql_query("select parentid, category from photo_cate where status = 'active' order by parentid desc limit 0,1"));
					echo $eventGallery['category']; ?></p>
			...
			<div class="row">
				...
				while ($row_subcate = mysql_fetch_array($sub_query)) {
					...
					// echo'</pre>';
				?>
					<div class="<?php if ($row_subcate['extraClass'] != '') {
									echo $row_subcate['extraClass'];
								} else {
