...
<div class="section-title-style-2">
	<h1><?php 
			...
			{
				$galleryCate = mysql_fetch_array( mysql_query( "select category,description from photo_cate where status = 'active' and parentid = '$_GET[type]'"));
				echo $galleryCate['category'];
				$gallery_desc=$galleryCate['description'];
			}
