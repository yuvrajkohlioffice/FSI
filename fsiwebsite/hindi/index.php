...
<body class="hindi_home">
    ...
    <section class="rev_slider_wrapper gardener-banner" style="height:400px;">
		<div id="slider1" class="rev_slider"  data-version="5.0" style="height:400px;">
			<ul>
			    <?php
        			$count = 0;
        			$slider = mysql_query( "select name, banner, teaser, details, otherurl,target from sliders where type = '_home' and status = 'active' and (websitetype='hindi' || websitetype='both') order by sorder, name");
		...
		<div class="container-fluid">
			<div class="row">				
				<div class="col-lg-3 col-md-12">    
					<a class="contact-button" href=""><div class="contact-us-button">मह्त्वपूर्ण लिंक </div>
	...
	<div class="container">
		...
		while($row_news=mysql_fetch_array($result_news))
		{
			...
			$title = $row_news['title_hindi'];
			
			if($title==''){
				$title=$row_news['title'];
			}
			
			if($row_news['extension_hindi']!='' && file_exists("../uploads/news/".$row_news['extension_hindi']))
			{
				$link = "../uploads/news/".$row_news['extension_hindi'];
				$target  = "_blank";
			}
...
<!--marquee behavior="alternate" direction="left" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();" style="color:#ff0000;font-size:16px;margin-top:-6px;">Due to some technical snag at NRSC, the dissemination of SNPP-VIIRS base Forest Fire alerts have been suspended till the problem is resolved.</marquee-->			
                    ...
                    <h2 class="cat-title" style="font-size: 20px;">भारतीय वन सर्वेक्षण समाचार </h2>
                    <div class="bd">						
							...
							<tbody>
							    <tr>
									<td style="padding: 4px;">
									   <a href="#"><p class="home_p">भारतीय वन सर्वेक्षण में आपका स्वागत है </p></a>
									</td>
								</tr>
								<?php
								...
								<tr>
									<td style="padding: 4px;">
										...
										<a href="<?php echo $link;?>" target="<?php echo $target;?>"><p><?php echo $title;?></p></a>
									</td>
								</tr>
								<?php } ?>							
								</tbody>
				...
				<div class="col-lg-5 col-md-8 col-sm-12 col-xs-12">
					<h2>पर्यावरण, वन एवं जलवायु परिवर्तन मंत्रालय<b><br> 
					<?php 
						$row_welcome = mysql_fetch_array(mysql_query("select sno, front, heading, detail, otherurl, target, banner from welcome where websitetype='hindi'")); 
                    ...
                    <?php if( $row_welcome['otherurl']!= "" ) { ?><div><a class="contact-button" href="<?php echo $row_welcome['otherurl']; ?>" target="<?php echo $row_welcome['target']; ?>"><div class="contact-us-button">आगे पढ़ें</div><i class="fa fa-arrow-circle-right"></i></a></div><?php } ?>
				</div>
				<div class="col-lg-4 col-md-9 col-sm-12 col-xs-12 ">
                <div class="mg">
                <h3>
                <?php 
					$row_welcome = mysql_fetch_array(mysql_query("select sno, front, heading, detail, otherurl, target, banner from welcome_sec where websitetype='hindi'")); 
					echo $row_welcome['heading'];
					$bannerExists = 0;
					if( $row_welcome['banner'] != "" && file_exists( "../uploads/images/banner/".$row_welcome['banner'])) { 
						$bannerExists = 1;
				...
				?>
                        ...
                        <p><?php //echo $row_welcome['front'];?>
<!----- modified content---->
<div>
<table>
<tr>
<td><img src="/images/santosh-tiwari.jpg" style="width: 123px;
height: 111px;"></td><td style="padding-left:5px"><b>श्री संतोष तिवारी, भा. व. से </b>
<br>महानिदेशक
<br>भारतीय वन सर्वेक्षण
<br>(पर्यावरण, वन एवं जलवायु परिवर्तन मंत्रालय)</td>
</tr>
</table>
</div>
<!--------------------------------------------->
                        ...
                        <div class="list-box clearfix">
    						<ul>
    							<li><i class="fa fa-envelope"></i><a href="dg-message">संदेश देखें</a></li>
    							
    						</ul>
    						<ul>
    							<li><i class="fa fa-user"></i><a href="director-general">प्रोफाइल देखें</a></li>
	...
	<section id="our-services-gardener">
		<div class="container">
			<div class="section-title2">
            	<p>हम विभिन्न सेवाएं प्रदान करते हैं</p>
				<h1><span>एफएसआई गतिविधियां और सेवाएं</span></h1>
			</div>
			<div class="row">
			    <?php
				$sno=0;
				$query = "select title, package_heading, description, link, extension, image, target from services where status='active' and primeArea = 1 and websitetype='hindi' order by sorder, postdate asc";
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                	<div class="single-service-item">
                        ...
                        <div class="service-text">
                            ...
                            <p><?php echo $dataServices['description'];?></p>
                        </div>
                    </div>
                </div>
	...
	<section id="latest-project-gardener">
		<div class="container">
			<div class="section-title2">
            	<p><?php $eventGallery = mysql_fetch_array( mysql_query( "select parentid, category, category_hindi from photo_cate where status = 'active' order by parentid desc limit 0,1" )); echo $eventGallery['category_hindi']; ?></p>
				<h1><span>हमारे हाल के कार्यक्रम</span></h1>
			</div>
			<div class="row">
			    <?php
				...
				?>
                <div class="col-lg-12">    
				<a class="contact-button" href="photo-gallery">
                    <div class="contact-us-button">और कार्यक्रम देखें</div>
