...
class common
{
	...
	{
		$this->site_name="भारतीय वन सर्वेक्षण";		
		$this->front=0;	
		...
		$res_settings = mysql_query("select website_name, twitter,facebook,youtube,linkedin,footer_note,address,phone,mobile,tripadvisor, friendly_url, skype, googlemap, googleplus, email_id, default_additional_note, meta_title from settings where websitetype='hindi'");
