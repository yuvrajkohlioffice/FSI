...
<head>
    ...
    <style>
        ...
        .custom-file-input { max-width: 160px !important; }
...
<body>
    <div class="container">
        ...
        <?php if (isset($_GET['status']) && $_GET['status'] == 'error'): ?>
            <div class="alert alert-danger text-center" role="alert">
                <?php echo htmlspecialchars("Error submitting application: " . ($_GET['message'] ?? 'Unknown error'), ENT_QUOTES, 'UTF-8'); ?>
            </div>
        <?php endif; ?>
        ...
        <form action="submit_application.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-check mb-4">
                <input type="checkbox" class="form-check-input" id="declaration_ack" name="declaration_ack" required>
    ...
    <div class="success-overlay" id="successOverlay">
        <div class="success-message-box">
            ...
            <button class="btn btn-close-success" onclick="closeSuccessMessage()">OK</button>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (status === 'success') {
                ...
                const duplicateModal = new bootstrap.Modal(document.getElementById('duplicateApplicationModal'));
        ...
        function previewImage(event, previewContainerId, defaultText) {
            ...
            const maxSizeSignature = 300 * 1024;
            ...
            if (fileInput.files && fileInput.files[0]) {
                ...
                if (fileInput.id === 'applicant_photo') {
                    currentMaxSize = maxSizePhoto;
                    maxSizeText = "2MB";
                } else if (fileInput.id === 'applicant_sig') {
                    currentMaxSize = maxSizeSignature;
                    maxSizeText = "300KB";
                } else {
                    currentMaxSize = Infinity; 
                    maxSizeText = "Not specified";
                }

                if (file.size > currentMaxSize) {
                    alert('File is too large. Maximum size for this field is ' + maxSizeText + '.');
                    fileInput.value = ''; 
                ...
                reader.onload = function(e) {
                    previewContainer.innerHTML = '<img src="' + e.target.result + '" alt="' + defaultText + '"/>';
                };
        ...
        document.getElementById('addEducationRow').addEventListener('click', function() {
            ...
            for (let i = 0; i < inputs.length; i++) {
                ...
                if (input.type === 'number' || input.type === 'text' || input.type === 'date' || input.tagName.toLowerCase() === 'textarea') {
                    input.value = '';
                }
                if (input.placeholder && input.name === 'edu_exam[]') {
